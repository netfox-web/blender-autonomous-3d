...
def main(argv: list[str] | None = None, *, hooks: dict | None = None) -> int:
    ...
    rows = [
        ...
        {"check": "orientation landmark parity", "status": "REAL_LOGIC", "evidence": json.dumps((result.get("scenarios") or {}).get("orientationParity"))},
        {"check": "serialized orientation tamper BLOCK", "status": "REAL_LOGIC" if result.get("serializedOrientationTamperBlocked") else "MISSING", "evidence": result.get("serializedOrientationTamperBlocked")},
        {"check": "strict type tamper BLOCK", "status": "REAL_LOGIC" if result.get("strictTypeTamperBlocked") else "MISSING", "evidence": result.get("strictTypeTamperBlocked")},
        {"check": "coordinated oracle tamper BLOCK", "status": "REAL_LOGIC" if result.get("coordinatedOracleTamperBlocked") else "MISSING", "evidence": result.get("coordinatedOracleTamperBlocked")},
        {"check": "canonical geometry tamper BLOCK", "status": "REAL_LOGIC" if result.get("canonicalGeometryTamperBlocked") else "MISSING", "evidence": result.get("canonicalGeometryTamperBlocked")},
        {"check": "near-tolerance oracle tamper BLOCK", "status": "REAL_LOGIC" if result.get("nearToleranceOracleTamperBlocked") else "MISSING", "evidence": result.get("nearToleranceOracleTamperBlocked")},
        {"check": "finite canonical geometry tamper BLOCK", "status": "REAL_LOGIC" if result.get("finiteCanonicalGeometryTamperBlocked") else "MISSING", "evidence": result.get("finiteCanonicalGeometryTamperBlocked")},
    ...
    body = {
        ...
        "serializedOrientationTamperBlocked": bool(result.get("serializedOrientationTamperBlocked")),
        "strictTypeTamperBlocked": bool(result.get("strictTypeTamperBlocked")),
        "coordinatedOracleTamperBlocked": bool(result.get("coordinatedOracleTamperBlocked")),
        "canonicalGeometryTamperBlocked": bool(result.get("canonicalGeometryTamperBlocked")),
        "nearToleranceOracleTamperBlocked": bool(result.get("nearToleranceOracleTamperBlocked")),
        "finiteCanonicalGeometryTamperBlocked": bool(result.get("finiteCanonicalGeometryTamperBlocked")),
        "rows": rows,
