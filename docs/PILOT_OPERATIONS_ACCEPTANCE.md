...
generatedAt: 2026-09-08T21:59:00.530087+00:00
...
| KD_FURNITURE packet checksum | REAL | `3896da583450` |
| KD_FURNITURE WO COMPLETED | REAL | `COMPLETED` |
| RETAIL_FIXTURE packet checksum | REAL | `4fd8ad2fed92` |
| RETAIL_FIXTURE WO COMPLETED | REAL | `COMPLETED` |
| PACKAGING_STRUCTURE packet checksum | REAL | `1b68f3ff9e35` |
| PACKAGING_STRUCTURE WO COMPLETED | REAL | `COMPLETED` |
| ACRYLIC_SHEET packet checksum | REAL | `6e59aefe4af9` |
...
| carrier quote | IMPORTED | `54690e83` |
