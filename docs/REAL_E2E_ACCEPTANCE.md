...
- `pilotBatchExecutionReady`: **FIXTURE / REAL_LOGIC** (scoped, not Production Ready) — see `docs/PILOT_BATCH_EXECUTION_ACCEPTANCE.md` (CODE `d0f5bbd`, generation `75f9d22c-8b38-4e96-ae73-4d3c66907abe`; 4 SKU × 5 units; independent BOM + packaging checklist authority + WO owner fail-closed; `physicalPilotBatchValidated=false`; `batchLaunchDecision=WAITING_HUMAN_EVIDENCE`)
