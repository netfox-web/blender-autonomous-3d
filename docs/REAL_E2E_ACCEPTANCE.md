...
- `pilotBatchExecutionReady`: **FIXTURE / REAL_LOGIC** (scoped, not Production Ready) — see `docs/PILOT_BATCH_EXECUTION_ACCEPTANCE.md` (CODE `83f4fe0`, generation `64077573-bb56-4d50-8501-8e5ee8f0b3f4`; 4 SKU × 5 units; exact-set authority; `physicalPilotBatchValidated=false`; `batchLaunchDecision=WAITING_HUMAN_EVIDENCE`)
