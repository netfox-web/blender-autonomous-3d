...
- `pilotBatchExecutionReady`: **FIXTURE / REAL_LOGIC** (scoped, not Production Ready) — see `docs/PILOT_BATCH_EXECUTION_ACCEPTANCE.md` (CODE `12ef546`, generation `4c1fa7ed-57d2-45bf-b3d1-ecf70e3efb53` runner-bound on that SHA; CODE Actions `34481806339` Ubuntu+Windows SUCCESS; docs `9a58803` Actions `34483517716`; 4 SKU × 5 units; `physicalPilotBatchValidated=false`; `batchLaunchDecision=WAITING_HUMAN_EVIDENCE`)
