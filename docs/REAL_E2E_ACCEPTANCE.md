...
- `surfaceDecorationLogicReady`: **REAL_LOGIC** — see `docs/ARTWORK_PLACEMENT_ACCEPTANCE.md` (CODE `48869d4`, generation `e9e36a84-9a9a-48e3-a558-e59dd9c88067`; 2400×1800 4-door master; production PNG lineage; Mock preview; `physicalPrintValidated=false`)
