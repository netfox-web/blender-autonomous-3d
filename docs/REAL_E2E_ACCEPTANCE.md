...
- `realArtworkPreviewReady`: **true / REAL** — Blender 5.2.1 LTS + NVIDIA T1000 OptiX Product Truth still (`docs/PRODUCT_TRUTH_RENDER_PACK_ACCEPTANCE.md`, CODE `635b316`, generation `2dafd469-0380-4169-96a8-15a42dfbb136`); not physical print
