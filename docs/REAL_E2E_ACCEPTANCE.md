...
- `pilotBatchExecutionReady`: **FIXTURE / REAL_LOGIC** (scoped, not Production Ready) — see `docs/PILOT_BATCH_EXECUTION_ACCEPTANCE.md` (CODE `b1f29f8`, generation `31913444-645f-462a-acdf-d3dc61d102f5`; 4 SKU × 5 units; QC/WO/qcPlanHash, carton measured, durable material, labor/cost lineage authority; `physicalPilotBatchValidated=false`; `batchLaunchDecision=WAITING_HUMAN_EVIDENCE`)
