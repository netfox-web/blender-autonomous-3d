...
- `surfaceDecorationLogicReady`: **REAL_LOGIC** — see `docs/ARTWORK_PLACEMENT_ACCEPTANCE.md` (CODE `f002c55`, generation `ff5ec0b8-26bc-4ce8-9036-c76538a6b90d`; canonical expected from landmark fixture/UV/slot; strict type + coordinated oracle tampers BLOCK; Mock preview; `physicalPrintValidated=false`)
