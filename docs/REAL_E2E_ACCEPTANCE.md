...
- `surfaceDecorationLogicReady`: **REAL_LOGIC** — see `docs/ARTWORK_PLACEMENT_ACCEPTANCE.md` (CODE `1661da5`, generation `62bed682-1076-4e06-9e1e-d1a971d46793`; CONTAIN+COVER landmark oracle matrix; Mock preview; `physicalPrintValidated=false`)
