...
- `pilotBatchExecutionReady`: **FIXTURE / REAL_LOGIC** (scoped, not Production Ready) — see `docs/PILOT_BATCH_EXECUTION_ACCEPTANCE.md` (CODE `25a583a`, generation `63023672-b1ec-4ba2-823a-3153a0b45d52`; 4 SKU × 5 units; independent WO material durable authority + cost quantity/identity recompute; `physicalPilotBatchValidated=false`; `batchLaunchDecision=WAITING_HUMAN_EVIDENCE`)
