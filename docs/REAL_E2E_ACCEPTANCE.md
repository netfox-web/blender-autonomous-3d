...
- `pilotBatchExecutionReady`: **FIXTURE / REAL_LOGIC** (scoped, not Production Ready) — see `docs/PILOT_BATCH_EXECUTION_ACCEPTANCE.md` (CODE `12ef546`, generation `4c1fa7ed-57d2-45bf-b3d1-ecf70e3efb53`; exact CODE SHA Actions `34481806339` Ubuntu+Windows SUCCESS; 4 SKU × 5 units; independent BOM + packaging checklist authority + WO owner fail-closed; `physicalPilotBatchValidated=false`; `batchLaunchDecision=WAITING_HUMAN_EVIDENCE`)
