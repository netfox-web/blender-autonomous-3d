...
- `pilotBatchExecutionReady`: **FIXTURE / REAL_LOGIC** (scoped, not Production Ready) — see `docs/PILOT_BATCH_EXECUTION_ACCEPTANCE.md` (CODE `f4c2df8`, generation `11ee2235-13d6-4e57-b092-4607bb194b0c`; 4 SKU × 5 units; checklist/QC PASS/board/execution authority; `physicalPilotBatchValidated=false`; `batchLaunchDecision=WAITING_HUMAN_EVIDENCE`)
