...
- `realArtworkPreviewReady`: **true / REAL** — Blender 5.2.1 LTS + NVIDIA T1000 OptiX Product Truth still (`docs/PRODUCT_TRUTH_RENDER_PACK_ACCEPTANCE.md`, CODE `e63fe7a`, generation `c28a6bc6-4ced-436d-ac95-9aa3562f81bb`); not physical print
