...
- `surfaceDecorationLogicReady`: **REAL_LOGIC** — see `docs/ARTWORK_PLACEMENT_ACCEPTANCE.md` (CODE `e3eddd3`, generation `fcfca28e-0e40-4b94-8b0b-7a04841015b8`; strict serialized bool/rotation/RGB types; Mock preview; `physicalPrintValidated=false`)
